...
% pointsA = detectFASTFeatures(leftI, 'MinContrast', ptThresh, 'MinQuality', minQuality);
% pointsB = detectFASTFeatures(rightI, 'MinContrast', ptThresh, 'MinQuality', minQuality);
